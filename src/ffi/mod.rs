...
pub(crate) use pyo3_ffi::{
    ...
    PyBytes_FromStringAndSize, PyBytes_Type, PyCFunction_NewEx, PyCallable_Check, PyCapsule_Import,
    ...
    PyModuleDef_Slot, PyObject, PyObject_Call, PyObject_CallMethodObjArgs, PyObject_CallOneArg,
    PyObject_GenericGetDict, PyObject_GetAttr, PyObject_HasAttr, PyObject_Vectorcall, PyTuple_New,
